...
class HeartyGlyphLightWidget extends WP_Widget {

	function __construct() {

		$widget_options = array(
			'classname' => 'heartyglyphlight_widget',
			'description' => 'Displays a HeartyGlyphLight instance',
		);

		parent::__construct( 'heartyglyphlight_widget', 'HeartyGlyphLight Widget', $widget_options );
